...
export {
  ...
  _hasProceduralSelectorCase,
  _nextSiblingElement,
  _notPlainSelectorCase,
  _notProceduralSelectorCase,
  _parseCSSInstruction,
  _parseKeyValueMatchRules,
  _stripCssOperator,
  _upwardIntCase,
  _upwardPlainSelectorCase,
  _upwardProceduralSelectorCase,
}
